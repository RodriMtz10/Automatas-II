...
public class GoTraductor extends GameRoleBaseVisitor<String> {
    ...
    public String visitDeclaracion(GameRoleParser.DeclaracionContext ctx) {
        ...
        String tipoGo = switch (tipoOriginal) {
            case "Simulacion" -> "int";
            case "Simulacion_vida" -> "string";
            case "Simulacion_construccion" -> "bool";
            case "Simulacion_vuelo" -> "float64";
            default -> "interface{}";
        };
        
        return getIndent() + "var " + id + " " + tipoGo + " = " + expr + "\n";
    }
    ...
    public String visitRepeticionWhile(GameRoleParser.RepeticionWhileContext ctx) {
        ...
        sb.append(getIndent()).append("for ").append(cond).append(" {\n");
        indentLevel++;
        sb.append(visit(ctx.bloque()));
        indentLevel--;
        sb.append(getIndent()).append("}\n");
    ...
    public String visitImprimir(GameRoleParser.ImprimirContext ctx) {
        ...
        return getIndent() + "fmt.Println(" + expr + ")\n";
    }
