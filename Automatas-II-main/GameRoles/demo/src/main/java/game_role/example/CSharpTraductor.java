...
public class CSharpTraductor extends GameRoleBaseVisitor<String> {
    ...
    public String visitDeclaracion(GameRoleParser.DeclaracionContext ctx) {
        ...
        String tipoCS = switch (tipoOriginal) {
            case "Simulacion" -> "int";
        ...
        return getIndent() + tipoCS + " " + id + " = " + expr + ";\n";
    }
    ...
    public String visitImprimir(GameRoleParser.ImprimirContext ctx) {
        ...
        return getIndent() + "Console.WriteLine(" + expr + ");\n";
    }
